                    ...
                    <div className='modal-dialog modal-dialog-centered modal-xl' role='document'>
                        <div className='modal-content'>
                            <div className='modal-header'>
                                <h5 className='modal-title' id='planMealModalTitle'>Plan This Meal</h5>
                                <button type='button' className='close close-btn' data-dismiss='modal'>
                                    <i className="far fa-window-close"></i>
                                </button>
                            </div>
                            <div className='modal-body'>
                                <form onSubmit={(e) => this.planMeal(e)}>
                                    ...
                                    <div className='form-row'>
                                        <div className='col'>
                                            <button type='submit' className='btn btn-outline-dark btn-block modal-btn' data-toggle='modal' data-target='#planMealModal' onClick={(e) => this.planMeal(e)}>Plan Meal</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
