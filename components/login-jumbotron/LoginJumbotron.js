          ...
          <div className="container">
            <div className="row" id="jumbotronSignUpContent">
              <div className="col-md-6">
                <div className="container">
                  ...
                  <p className="lead text-center">
                    Create a profile, customize your regiment, and find new
                    foods.
                  </p>
                  <div className="card">
                    <img
                      src="static/img/sushi.jpg"
                      className="card-img jumbotronImg"
                    />
                  </div>
                </div>
              </div>
              <div className="col-md-6">
                <div className="container">
                  <form>
                    <h4 className="text-center" id="jumbotronLabelSignUp">
                      Sign Up
                    </h4>
